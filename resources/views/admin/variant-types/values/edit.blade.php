...
@section('title', 'Edit Value - ' . $variantType->name)
...
<div class="row">
    <div class="col-lg-6">
            ...
            <div class="card-body py-2">
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <small class="text-muted">Editing value for this type</small>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <form id="value-form" action="{{ route('admin.variant-types.values.update', [$variantType->id, $value->id]) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="color_code" id="color_code" class="form-control" 
                                   value="{{ old('color_code', $value->color_code) }}"
                                   placeholder="#FF0000">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="sort_order" id="sort_order" class="form-control" 
                               value="{{ old('sort_order', $value->sort_order) }}" min="0">
