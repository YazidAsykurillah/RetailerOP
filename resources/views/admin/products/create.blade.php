        ...
        document.getElementById('images').addEventListener('change', function(e) {
            ...
            Array.from(e.target.files).forEach(function(file, index) {
                ...
                reader.onload = function(event) {
                    ...
                    col.innerHTML = '<div class="card"><img src="' + event.target.result + '" class="card-img-top" style="height: 150px; object-fit: cover;"><div class="card-body p-2 text-center"><small>' + (index === 0 ? '<span class="badge badge-primary">Primary</span>' : 'Image ' + (index + 1)) + '</small></div></div>';
